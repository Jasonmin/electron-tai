...
(function(global, factory) {
            ...
            RongIMClient.init = function(appKey, dataAccessProvider, options, callback) {
                ...
                var _sourcePath = {
                    protobuf: 'cdn.ronghub.com/protobuf-2.3.5.min.js'
                        // protobuf: 'http://cdn.ronghub.com/protobuf-2.3.5.min.js' // zq
                };
    ...
    (function(RongIMLib) {
        ...
        var _topic = [
            "invtDiz", "crDiz", "qnUrl", "userInf", "dizInf", "userInf", "joinGrp", "quitDiz", "exitGrp", "evctDiz", ["", "ppMsgP", "pdMsgP", "pgMsgP", "chatMsg", "pcMsgP", "", "pmcMsgN", "pmpMsgN", "", "", "", "prMsgS"],
        ...
        var Bridge = (function() {
            ...
            Bridge.prototype.connect = function(appKey, token, callback) {
                if (!RongIMLib.RongIMClient.Protobuf) { //zq
                    return;
                }
            ...
            function FeatureDectector(callback) {
                ...
                if ("WebSocket" in window && "ArrayBuffer" in window && WebSocket.prototype.CLOSED === 3 && !RongIMLib.RongIMClient._memoryStore.depend.isPolling) {
                    ...
                    if (!RongIMLib.RongIMClient.Protobuf) {
                        ...
                        script.src = url;
                        // script.src = "./assets/js/protobuf-2.3.5.min.js"; // elec-zq userless
                        // RongIMLib.RongIMClient.Protobuf = Polling; // elec-zq userless
